...
Revision ID: add_automation_001
Revises: fix_version_algoritmo_length
...
revision = 'add_automation_001'
down_revision = 'fix_version_algoritmo_length'  # Ajustar según última migración
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('criterios_evaluados', sa.JSON(), nullable=True),
        sa.Column('configuracion_utilizada', sa.JSON(), nullable=True),
        sa.Column('metadata', sa.JSON(), nullable=True),
        sa.Column('version_algoritmo', sa.String(length=20), nullable=False, server_default='1.0'),
        ...
        sa.Column('requirio_accion_manual', sa.Boolean(), default=False),
        sa.Column('override_manual', sa.Boolean(), default=False),
    ...
    op.create_table(
        ...
        sa.Column('total_facturas_procesadas', sa.BigInteger(), default=0),
        sa.Column('total_aprobadas_automaticamente', sa.BigInteger(), default=0),
        sa.Column('total_enviadas_revision', sa.BigInteger(), default=0),
        sa.Column('total_rechazadas', sa.BigInteger(), default=0),
        sa.Column('tasa_automatizacion', sa.Numeric(precision=5, scale=2), default=0.0),
        sa.Column('tasa_precision', sa.Numeric(precision=5, scale=2), default=0.0),
        ...
        sa.Column('patrones_detectados', sa.JSON(), nullable=True),
        sa.Column('total_proveedores_procesados', sa.BigInteger(), default=0),
        sa.Column('top_proveedores', sa.JSON(), nullable=True),
        sa.Column('monto_total_procesado', sa.Numeric(precision=20, scale=2), default=0.0),
        sa.Column('monto_total_aprobado_auto', sa.Numeric(precision=20, scale=2), default=0.0),
        sa.Column('total_errores', sa.BigInteger(), default=0),
        sa.Column('errores_detalle', sa.JSON(), nullable=True),
        sa.Column('metadata', sa.JSON(), nullable=True),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table(
        ...
        sa.Column('valor_minimo', sa.JSON(), nullable=True),
        sa.Column('valor_maximo', sa.JSON(), nullable=True),
        sa.Column('valores_permitidos', sa.JSON(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('trust_score', sa.Numeric(precision=5, scale=4), nullable=False, default=0.5),
        sa.Column('nivel_confianza', sa.String(length=20), nullable=False, default='medio'),
        sa.Column('total_facturas', sa.BigInteger(), default=0),
        sa.Column('facturas_aprobadas', sa.BigInteger(), default=0),
        sa.Column('facturas_rechazadas', sa.BigInteger(), default=0),
        sa.Column('facturas_aprobadas_auto', sa.BigInteger(), default=0),
        sa.Column('tasa_aprobacion', sa.Numeric(precision=5, scale=2), default=0.0),
        sa.Column('tasa_automatizacion_exitosa', sa.Numeric(precision=5, scale=2), default=0.0),
        sa.Column('historial_confianza', sa.JSON(), nullable=True),
        sa.Column('patrones_recurrentes', sa.JSON(), nullable=True),
