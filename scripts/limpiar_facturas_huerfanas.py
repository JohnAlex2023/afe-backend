"""
Script para limpiar facturas huerfanas - facturas con responsable_id pero sin asignacion activa.
...
SOLUCION: Este script identifica y limpia esas facturas huerfanas.
"""
...
def main():
    ...
    try:
        print("\n" + "="*70)
        print("LIMPIEZA DE FACTURAS HUERFANAS")
        print("="*70)
        ...
        for responsable_id, facturas in facturas_por_responsable.items():
            ...
            if asignaciones_activas == 0:
                ...
                print("    -> FACTURAS HUERFANAS (se deben limpiar)")
        ...
        if len(facturas_huerfanas) > 0:
            ...
            msg = f"\nDesea limpiar {len(facturas_huerfanas)} facturas huerfanas? (si/no): "
            respuesta = input(msg)
